__all__=('AcroForm',)
from lib.reportlab.pdfbase.pdfdoc import (PDFObject, PDFArray, PDFDictionary, PDFString, pdfdocEnc,
                                    PDFName, PDFStream, PDFStreamFilterZCompress, escapePDF)
from lib.reportlab.pdfbase.pdfmetrics import stringWidth
from lib.reportlab.lib.colors import Color, CMYKColor, Whiter, Blacker, opaqueColor
from lib.reportlab.lib.rl_accel import fp_str
from lib.reportlab.lib.utils import isStr, asNative
import weakref
