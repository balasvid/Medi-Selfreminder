...
from lib.reportlab.pdfbase import _fontdata
from lib.reportlab.lib.logger import warnOnce
from lib.reportlab.lib.utils import rl_isfile, rl_glob, rl_isdir, open_and_read, open_and_readlines, findInPaths, isSeq, isStr
from lib.reportlab.rl_config import defaultEncoding, T1SearchPath
from lib.reportlab.lib.rl_accel import unicode2T1, instanceStringWidthT1
from lib.reportlab.pdfbase import rl_codecs
_notdefChar = b'n'
