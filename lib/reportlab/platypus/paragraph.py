...
from lib.reportlab.pdfbase.pdfmetrics import stringWidth, getAscentDescent
from lib.reportlab.platypus.paraparser import ParaParser, _PCT, _num as _parser_num, _re_us_value
from lib.reportlab.platypus.flowables import Flowable
from lib.reportlab.lib.colors import Color
from lib.reportlab.lib.enums import TA_LEFT, TA_RIGHT, TA_CENTER, TA_JUSTIFY
from lib.reportlab.lib.geomutils import normalizeTRBL
from lib.reportlab.lib.textsplit import wordSplit, ALL_CANNOT_START
from lib.reportlab.lib.styles import ParagraphStyle
from copy import deepcopy
from lib.reportlab.lib.abag import ABag
from lib.reportlab.rl_config import decimalSymbol, _FUZZ, paraFontSizeHeightOffset,\
    hyphenationMinWordLength
from lib.reportlab.lib.utils import _className, isBytes, isStr
from lib.reportlab.lib.rl_accel import sameFrag
import re
